package com.haigelasi.mall.core.aop;
...
import com.haigelasi.mall.core.log.LogManager;
import com.haigelasi.mall.core.log.LogTaskFactory;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(com.haigelasi.mall.bean.core.BussinessLog)")
