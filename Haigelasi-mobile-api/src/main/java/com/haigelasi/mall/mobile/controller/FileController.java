...
public class FileController extends BaseController {
     ...
     * @param idFile
     */
    @RequestMapping(value="getStreamById",method = RequestMethod.GET)
    public void getStreamById(@RequestParam("idFile") Long idFile,HttpServletResponse response){
